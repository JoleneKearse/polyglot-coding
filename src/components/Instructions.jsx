...
const Instructions = () => {
  return (
    <>
      <h2>I know you're asking, So what you doing?</h2>
      <p>I impulse bought this utterly fantastic course <a href="https://codewithmosh.com/p/python-projects-for-beginners" target="_blank" rel="noopener noreferrer">Python Projects for Beginners by CodeWithMosh</a> that strengthens your problem-solving skills.</p>
      ...
      <ul>
        ...
        <li>Compare the code in all languages.</li>
      </ul>
    </>
  )
}
